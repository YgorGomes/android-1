...
import com.example.meupc.controlecotacoes.R;
...
/**
 * Created by MeuPC on 14/03/2017.
 */

public class DBOpenHelper extends SQLiteOpenHelper {

    private static final String DB_NAME="controle_cotacoes.db";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        for(int i= oldVersion; i< newVersion; i++){
            ...
            log("Looking milgration file: "+migrationFileName);
